    ...
    <div class="">
        ...
        <form id="contact" class="flex flex-col w-11/12 lg:w-6/12 m-auto" action="{{ route('contacts.store') }}"
            ...
            <div class="flex flex-col mt-4">
                ...
                <input class="relative inputForm text-primary" type="text" name="prenom" id="prenom"
            ...
            <div class="flex flex-col mt-4">
                ...
                <input class="relative inputForm text-primary" type="text" name="nom" id="nom"
            ...
            <div class="flex flex-col mt-4">
                ...
                <input class="relative inputForm text-primary" type="email" name="email" id="email"
