<footer class="realtive bg-gray-900 mb-0 pb-16 md:pb-2 w-full relative bottom-0 mt-12 h-auto">
    ...
    <div class="xl:hidden fixed right-0 left-0 bottom-0 h-14 bg-white shadow-2xl rounded-t-sm z-50 text-primary">
    ...
    <div id="menu-mobile" class="invisible fixed bottom-0 w-full bg-white text-primary py-6">
