...
<div id="loaderPage" class="fixed inset-0 bg-primary bg-opacity-50 z-9999 flex justify-center items-center">
    <div class="flex justify-center items-baseline">
        <img src="{{ asset('images/favoris-mobile.png') }}" alt="" class="h-48">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-14 h-14 text-primary animate-spin">
