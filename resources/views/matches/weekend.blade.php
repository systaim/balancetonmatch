...
@dump($matches)
    ...
    @if($match->date_match->formatLocalized('%V') == now()->week() && ($match->date_match->formatLocalized('%A') == "vendredi" || $match->date_match->formatLocalized('%A') == "samedi" || $match->date_match->formatLocalized('%A') == "dimanche" ||
