                ...
                @foreach ($club->staffs->sortBy('last_name') as $key => $staff)
                    <div x-data="{ open: false }"
                        ...
                        <div class="flex justify-between">
                            <div class="relative">
                                <img class="object-cover h-80 w-full rounded-br-lg" src="{{ asset($staff->avatar_path) }}"
                            ...
                            <div class="text-lg flex justify-center items-start p-2">
                                <p class="capitalize vertical mx-2 font-semibold">{{ $staff->first_name }} <span
                                        class="uppercase">{{ $staff->last_name }}</span></p>
                            </div>
                        </div>
                                ...
                                <form action="{{ route('clubs.staffs.update', [$club, $staff]) }}" method="post"
                                    ...
                                    <div class="text-primary">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex flex-col">
                                                <select
                                                    class="inputForm focus:outline-none focus:shadow-outline w-full my-1"
                                                    name="quality" id="quality" value="{{ $staff->quality }}">
                                                    <option value="{{ $staff->quality }}">{{ $staff->quality }}
                                                    </option>
