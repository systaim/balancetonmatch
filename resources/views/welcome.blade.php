...
@section('content')
    ...
    <div id="slideHome" class="relative bg-gray-800 p-4">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:py-32 sm:px-6 lg:px-8">
            ...
            <p class="mt-6 text-sm lg:text-xl text-indigo-100 max-w-3xl">BalanceTonMatch.com a pour but de rassembler les
                passionnés du
                        ...
                        <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                            <a href="{{ route('articles.show', $article) }}">
                                <div class="flex-shrink-0">
                                    <img class="h-48 w-full object-cover" src="{{ asset($article->image) }}"
                                        alt="" loading="lazy">
                                </div>
                            </a>
